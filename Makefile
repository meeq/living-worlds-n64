...
$(error no scenes/ found - run 'make scenes' first)
endif
endif

# If no sounds have been fetched yet, provide instructions to fetch them.
ifeq ($(assets_wav),)
ifeq ($(filter clean scenes sounds,$(MAKECMDGOALS)),)
$(error no sounds/ found - run 'make sounds' first)
endif
endif
